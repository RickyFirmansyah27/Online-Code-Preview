...
export const CONTROL_STYLES = {
  button: "flex items-center gap-1.5 lg:gap-2 px-2 lg:px-3 py-3 lg:py-3.5 rounded-xl bg-gray-900/80 border border-gray-700/60 hover:bg-gray-800/80 hover:border-blue-500/50 transition-all duration-200 backdrop-blur-sm text-sm font-medium text-gray-200 group min-h-[48px] lg:min-h-[52px] w-full lg:w-72",
